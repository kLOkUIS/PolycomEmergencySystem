...
// Battery alert LED-only patterns.
static constexpr uint16_t BATTERY_STROBE_ON_MS = 28;
static constexpr uint16_t BATTERY_STROBE_OFF_MS = 12;
static constexpr uint16_t BATTERY_STROBE_GAP_MS = 90;
static constexpr uint8_t BATTERY_LOW_STROBE_COUNT = 2;
static constexpr uint8_t BATTERY_CRITICAL_STROBE_COUNT = 5;
